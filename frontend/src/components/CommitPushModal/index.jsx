...
const CommitPushModal = ({ open, onClose, conversationId }) => {
  const { t } = useTranslation('CommitPushModal');
    ...
    <>
      ...
      <Box sx={{ flex: 1, minWidth: 0 }}>
        ...
        <Autocomplete
          ...
          noOptionsText={t('noMatchingMembers')}
      ...
      >
        ...
        {step === STEP.LOADING && (
          ...
          >
            ...
            <Typography level="body-md">{t('loadingChanges')}</Typography>
          </Box>
        )}
        ...
        */}
        ...
        >
          ...
          <Box sx={{ display: "flex", flex: 1, overflow: "hidden" }}>
            ...
            >
              ...
              >
                {t('changedFiles', { count: files.length })}
              </Typography>
              ...
              >
                ...
                {fileDiff?.error && (
                  ...
                  >
                    ...
                    >
                      {t('failedToLoadDiff', { error: fileDiff.error })}
                    </Alert>
                  </Box>
                )}
        ...
        {step === STEP.CREATING_PR && (
          ...
          >
            <CircularProgress size="md" />
            <Typography level="body-md">{t('creatingPullRequest')}</Typography>
          </Box>
        )}
        ...
        {step === STEP.SUCCESS && (
          ...
          >
            ...
            >
              <span dangerouslySetInnerHTML={{ __html: t('changesPushedSuccessfully', { branch: branchName }) }} />
            </Alert>
            {prUrl ? (
              <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
                <Typography level="body-md">{t('pullRequestCreated')}</Typography>
                <Button
                  component="a"
                  href={prUrl}
                  target="_blank"
                ...
                >
                  {prTitle || t('openPullRequest')}
                </Button>
              </Box>
            ) : (
              <Alert color="warning" variant="soft">
                {t('pushSucceededPrFailed')}
              </Alert>
            )}
            <Button
              onClick={handleClose}
